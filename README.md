...
- Experimental surfaces: starter/example materials unless explicitly promoted
...
For release narrative and checklist material, see [CHANGELOG.md](CHANGELOG.md) and [docs/RELEASE_READINESS_CHECKLIST.md](docs/RELEASE_READINESS_CHECKLIST.md).
...
- `adapters/`: public domain adapters and package docs
