...
- current state: released public adapter slice with adapter contract, schemas, default/scenario policy, market-risk alternatives, replay/simulation artifacts, package-local docs, and playbook guidance
