...
- current state: promotion-hardened public `MA-M4` slice with adapter contract, schemas, default/scenario policy, coordination-branch alternatives, replay/simulation artifacts, package-local docs, and playbook guidance
