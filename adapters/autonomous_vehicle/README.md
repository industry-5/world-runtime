...
- current state: promotion-hardened public `AV-M4` slice with adapter contract, schemas, default/scenario policy, maneuver alternatives, replay/simulation artifacts, package-local docs, and playbook guidance
