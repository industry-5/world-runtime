...
class WorldRuntimeAppServer:
    ...
    def handle_request(self, method: str, params: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        handlers.update(self._world_game_handlers())
    ...
    def session_close(self, session_id: str) -> Dict[str, Any]:
        ...
        if self.world_game_service is not None:
    ...
    def _world_game_handlers(self) -> Dict[str, Any]:
        if self.world_game_service is None:
            return {}
        return {
    ...
    def _require_world_game_service(self):
        if self.world_game_service is None:
            raise ValueError("world_game support is not available in this repo build")
        return self.world_game_service
    ...
    def _require_world_game_context(self, session_id: str) -> Dict[str, Any]:
        self._require_session(session_id)
        self._require_world_game_service()
    ...
    def _execute_task(self, task: Task) -> Dict[str, Any]:
        ...
        if method.startswith("world_game.") and self.world_game_service is None:
            raise ValueError("world_game support is not available in this repo build")
