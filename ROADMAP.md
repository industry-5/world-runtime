...
- The World Game showcase stack currently pairs `labs/world_game_studio_next` as the primary showcase surface with `adapters/world_game` as the domain/runtime authority.
...
- `labs/world_game_studio` has been retired and should be treated only as historical milestone context where referenced.
